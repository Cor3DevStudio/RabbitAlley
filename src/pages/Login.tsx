...
import { STORAGE_PERMISSIONS } from "@/lib/storage-keys";
...
export default function Login() {
  ...
  if (isAuthenticated && user) {
    ...
    return <Navigate to={resolvePostLoginPath(user.role, permissions, fromPath)} replace />;
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      const targetPath = resolvePostLoginPath(result.user?.role, permissions, fromPath);
